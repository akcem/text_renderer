...
import datetime
"""
已转至app/child_app/dataset_merge.py和app/child_app/label_generation.py
"""
class PaddleOCRLabelGenerator:
    ...
    def setup_tabs(self, parent):
        ...
        self.notebook.add(self.tab2, text="renderer数据集合并(不需就点标签文件生成)")
        self.notebook.add(self.tab1, text="标签文件生成（paddle的）")
